...
public class GetProjectCommandHandler extends AbsCommandHandler<GetProjectCommand, JSONObject>
{
    ...
    public GetProjectCommandHandler(TestrailServiceContext testrailContext)
    {
    ...
    {
        try {
            return testrailContext.sendGet(TestrailAPI.Method.GET_PROJECT, new Object[]{command.getProjectId()}, null);
