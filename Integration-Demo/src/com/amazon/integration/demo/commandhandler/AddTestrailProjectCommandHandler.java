...
public class AddTestrailProjectCommandHandler extends AbsCommandHandler<AddTestrailProjectCommand, JSONObject>
{
    Logger logger = Logger.getLogger(this.getClass().getName());
    IntegTestrailContext integTestrailContext;

    public AddTestrailProjectCommandHandler(IntegTestrailContext integTestrailContext)
    {
